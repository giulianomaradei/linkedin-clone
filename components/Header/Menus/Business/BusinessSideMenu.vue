<template>
  <div ref="sideMenu" class="side-menu">
    ...
    <div class="close-side-menu" @click="closeMenu">X</div>

    <div class="menu-card">
      <div class="submenu-header">Visit more linkedin products</div>
      ...
      <div class="products-list">
        <div class="product">
          ...
          <div class="product-tittle">Learning</div>
        </div>
          ...
          <div class="product-icon">
            ...
            >
              ...
              <g fill="url(#app-ads-@1-a)">
                <path
                  d="M20 11.88A8.13 8.13 0 1111.88 20 8.13 8.13 0 0120 11.88M20 9a11 11 0 1011 11A11 11 0 0020 9z"
                ></path>
    ...
    <div class="menu-card">
      <div class="submenu-header">Explore more for business</div>
      <div class="header-divisor" />
      <div class="more-business">
        <div class="more">
          <div class="more-title">Hire on Linkedin</div>
          <div class="more-description">Find, attract and recruit talent</div>
        </div>

        <div class="more">
          <div class="more-title">Sell with LinkedIn</div>
          <div class="more-description">Build relationships with buyers</div>
        </div>

        <div class="more">
          <div class="more-title">Post a job for free</div>
          <div class="more-description">Find quality candidates</div>
        </div>

        <div class="more">
          <div class="more-title">Advertise on LinkedIn</div>
        ...
        <div class="more">
          <div class="more-title">Learn with LinkedIn</div>
          <div class="more-description">Courses to develop your employees</div>
        </div>

        <div class="more">
          <div class="more-title">Admin Center</div>
          <div class="more-description">Manage billing and account details</div>
        </div>
      </div>

      <div class="header-divisor" />

      <div class="submenu-footer">Create a Company Page +</div>
    </div>
  </div>
</template>
